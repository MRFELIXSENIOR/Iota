...
namespace iota {
	...
	namespace Application {
		bool IsInitialized() { return app_initialized; }
		bool IsRunning() { return app_running; }

		void Initialize(const std::string& window_title, int window_width, int window_height) {
		...
		void SetFrameLimit(unsigned int target) { app_framelimit = target; }
		int GetFrameLimit() { return app_framelimit; }
	}
}
